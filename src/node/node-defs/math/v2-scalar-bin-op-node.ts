...
export class Vec2ScalarBinOpNode extends BaseNode {
    ...
    constructor(pos: Vector2) {
        ...
        this._label = "Vector2 Scalar Binary Op"
        this._input = [
    ...
    code(): string {
        ...
        code = `vec2 ${getVariableNameForSocket(this.output[0].uId!)} = ${v1} ${this._parameters[0].value} ${num2};`
